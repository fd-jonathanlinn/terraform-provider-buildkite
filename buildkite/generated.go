...
type ClusterQueueCreateInput struct {
	// Autogenerated input type of ClusterQueueCreate
...
// GetClientMutationId returns ClusterQueueCreateInput.ClientMutationId, and is useful for accessing the field via an interface.
func (v *ClusterQueueCreateInput) GetClientMutationId() string { return v.ClientMutationId }

// GetOrganizationId returns ClusterQueueCreateInput.OrganizationId, and is useful for accessing the field via an interface.
func (v *ClusterQueueCreateInput) GetOrganizationId() string { return v.OrganizationId }

// GetClusterId returns ClusterQueueCreateInput.ClusterId, and is useful for accessing the field via an interface.
func (v *ClusterQueueCreateInput) GetClusterId() string { return v.ClusterId }

// GetKey returns ClusterQueueCreateInput.Key, and is useful for accessing the field via an interface.
func (v *ClusterQueueCreateInput) GetKey() string { return v.Key }

// GetDescription returns ClusterQueueCreateInput.Description, and is useful for accessing the field via an interface.
func (v *ClusterQueueCreateInput) GetDescription() string { return v.Description }

// Autogenerated input type of ClusterQueueDelete
type ClusterQueueDeleteInput struct {
	// Autogenerated input type of ClusterQueueDelete
	ClientMutationId string `json:"clientMutationId"`
	// Autogenerated input type of ClusterQueueDelete
	OrganizationId string `json:"organizationId"`
...
// GetClientMutationId returns ClusterQueueDeleteInput.ClientMutationId, and is useful for accessing the field via an interface.
func (v *ClusterQueueDeleteInput) GetClientMutationId() string { return v.ClientMutationId }

// GetOrganizationId returns ClusterQueueDeleteInput.OrganizationId, and is useful for accessing the field via an interface.
func (v *ClusterQueueDeleteInput) GetOrganizationId() string { return v.OrganizationId }

// GetId returns ClusterQueueDeleteInput.Id, and is useful for accessing the field via an interface.
func (v *ClusterQueueDeleteInput) GetId() string { return v.Id }

// Autogenerated input type of ClusterQueueUpdate
type ClusterQueueUpdateInput struct {
	// Autogenerated input type of ClusterQueueUpdate
	ClientMutationId string `json:"clientMutationId"`
	// Autogenerated input type of ClusterQueueUpdate
	OrganizationId string `json:"organizationId"`
...
// GetClientMutationId returns ClusterQueueUpdateInput.ClientMutationId, and is useful for accessing the field via an interface.
func (v *ClusterQueueUpdateInput) GetClientMutationId() string { return v.ClientMutationId }

// GetOrganizationId returns ClusterQueueUpdateInput.OrganizationId, and is useful for accessing the field via an interface.
func (v *ClusterQueueUpdateInput) GetOrganizationId() string { return v.OrganizationId }

// GetId returns ClusterQueueUpdateInput.Id, and is useful for accessing the field via an interface.
func (v *ClusterQueueUpdateInput) GetId() string { return v.Id }

// GetDescription returns ClusterQueueUpdateInput.Description, and is useful for accessing the field via an interface.
func (v *ClusterQueueUpdateInput) GetDescription() string { return v.Description }
...
type __createClusterQueueInput struct {
	Input ClusterQueueCreateInput `json:"input"`
}

// GetInput returns __createClusterQueueInput.Input, and is useful for accessing the field via an interface.
func (v *__createClusterQueueInput) GetInput() ClusterQueueCreateInput { return v.Input }

// __deleteClusterQueueInput is used internally by genqlient
type __deleteClusterQueueInput struct {
	Input ClusterQueueDeleteInput `json:"input"`
}

// GetInput returns __deleteClusterQueueInput.Input, and is useful for accessing the field via an interface.
func (v *__deleteClusterQueueInput) GetInput() ClusterQueueDeleteInput { return v.Input }
...
type __updateClusterQueueInput struct {
	Input ClusterQueueUpdateInput `json:"input"`
}

// GetInput returns __updateClusterQueueInput.Input, and is useful for accessing the field via an interface.
func (v *__updateClusterQueueInput) GetInput() ClusterQueueUpdateInput { return v.Input }
...
// GetClientMutationId returns createClusterQueueClusterQueueCreateClusterQueueCreatePayload.ClientMutationId, and is useful for accessing the field via an interface.
func (v *createClusterQueueClusterQueueCreateClusterQueueCreatePayload) GetClientMutationId() string {
...
type deleteClusterQueueClusterQueueDeleteClusterQueueDeletePayload struct {
	// A unique identifier for the client performing the mutation.
	ClientMutationId      string `json:"clientMutationId"`
	DeletedClusterQueueId string `json:"deletedClusterQueueId"`
}
...
// GetDeletedClusterQueueId returns deleteClusterQueueClusterQueueDeleteClusterQueueDeletePayload.DeletedClusterQueueId, and is useful for accessing the field via an interface.
func (v *deleteClusterQueueClusterQueueDeleteClusterQueueDeletePayload) GetDeletedClusterQueueId() string {
	return v.DeletedClusterQueueId
}
...
// GetClientMutationId returns updateClusterQueueClusterQueueUpdateClusterQueueUpdatePayload.ClientMutationId, and is useful for accessing the field via an interface.
func (v *updateClusterQueueClusterQueueUpdateClusterQueueUpdatePayload) GetClientMutationId() string {
	return v.ClientMutationId
}
...
mutation createClusterQueue ($input: ClusterQueueCreateInput!) {
	clusterQueueCreate(input: $input) {
		clientMutationId
		clusterQueue {
			id
			uuid
...
mutation deleteClusterQueue ($input: ClusterQueueDeleteInput!) {
...
mutation updateClusterQueue ($input: ClusterQueueUpdateInput!) {
	clusterQueueUpdate(input: $input) {
		clientMutationId
		clusterQueue {
			id
			uuid
